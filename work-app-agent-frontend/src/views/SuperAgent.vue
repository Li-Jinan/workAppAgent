<template>
  <div class="super-agent-container">
    <div class="header">
      ...
      <h1 class="title">lijinan AI超级智能体</h1>
...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'lijinan AI超级智能体是lijinan AI超级智能体应用平台的全能助手，能解答各类专业问题，提供精准建议和解决方案'
    },
    {
      name: 'keywords',
      content: 'lijinan AI超级智能体,智能助手,专业问答,AI问答,专业建议,AI助手,AI智能体'
    }
  ]
})
...
onMounted(() => {
  // 添加欢迎消息
  addMessage('你好，我是lijinan AI超级智能体。我可以解答各类问题，提供专业建议，请问有什么可以帮助你的吗？', false)
})
