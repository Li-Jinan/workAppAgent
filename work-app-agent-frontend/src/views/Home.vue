  ...
  <div class="home-container">
    <div class="header">
      <div class="glitch-wrapper">
        <h1 class="glitch-title">lijinan AI超级智能体</h1>
      </div>
    ...
    <div class="apps-container">
      <div class="app-card" @click="navigateTo('/work-assistant')">
        <div class="card-glow"></div>
        <div class="app-icon work-icon">💼</div>
        <div class="app-info">
          <div class="app-title">AI工作助手</div>
          <div class="app-desc">智能职场顾问，帮你解答工作难题</div>
        </div>
      ...
      <div class="app-card" @click="navigateTo('/super-agent')">
        ...
        <div class="app-info">
          <div class="app-title">lijinan AI超级智能体</div>
...
// 设置页面标题和元数据
useHead({
  title: 'lijinan AI超级智能体应用平台 - 首页',
  meta: [
    {
      name: 'description',
      content: 'lijinan AI超级智能体应用平台提供AI工作助手和lijinan AI超级智能体服务，满足您的各种AI对话需求'
    },
    {
      name: 'keywords',
      content: 'AI智能体,AI应用,AI工作助手,AI助手,智能对话,AI助手,lijinan AI超级智能体,首页'
    }
  ]
})
